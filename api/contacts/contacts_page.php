...
<div style="padding: 50px 0px 50px 0px;">
    ...
    <form class="form-horizontal" method="POST" action="../email/contact_sql_pass.php">

            <div class="form-group">
                <label for="colFormLabel" class="col-sm-4 col-form-label">Select Group for Contact:</label>
                <div class="col-sm-12">
            ...
            <div class="form-group">
                <label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label">First Name:</label>
                <div class="col-sm-12">
                    <textarea name="first_name" class="form-control form-gray-bg" id="exampleFormControlTextarea1" rows="1"></textarea>
                </div>
            </div>

            <div class="form-group">
                <label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label">Last Name:</label>
                <div class="col-sm-12">
                    <textarea name="last_name" class="form-control form-gray-bg" id="exampleFormControlTextarea1" rows="1"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <textarea name="email" class="form-control form-gray-bg" id="exampleFormControlTextarea1" rows="1"></textarea>
                </div>
            </div>

            <div class="form-group">
                <label for="colFormLabel" class="col-sm-4 col-form-label">Contact Type:</label>
                <div class="col-sm-12">
                    <div class="form-gray-bg">
                        <select id="example-getting-started" name="web_contact">
                            <optgroup label="Contact Types">
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-default" id="submit-btn">Create New Contact</button>
                </div>
            </div>
