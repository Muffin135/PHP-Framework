...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        if($user_email == $row["email"]){
            ...
            $preference_change = "UPDATE recipients SET single_email = 'Yes' WHERE email = '" . $user_email ."' ";
...
<div style="padding: 50px 0px 50px 0px;">
    <div class="container">
        ...
        You have opted in for a single email. From now on, you will be sent a single email containing all the reports for the groups you are assigned to.
